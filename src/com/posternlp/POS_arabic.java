 ...
 * @author 尚宏
 */
public class POS_arabic implements PosterNLPSegImpl{
    private static String models_path = "model/";
    private static String model_arabic = "arabic.tagger";
    private static MaxentTagger tagger = new MaxentTagger(models_path+model_arabic);
    ...
    public String[] getStringToken(String str) throws PosterNLPException {
        ...
        return output_text_array;
            ...
            throw new PosterNLPException("POS_arabic:"+e.getMessage());
        } 
    }
