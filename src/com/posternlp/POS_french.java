 ...
 * @author 尚宏
 */
public class POS_french implements PosterNLPSegImpl {

    private static String models_path = "model/";
    private static String model_french = "french.tagger";
    private static MaxentTagger tagger = new MaxentTagger(models_path + model_french);
    ...
    public String[] getStringToken(String str) throws PosterNLPException {
        try {
            ...
            throw new PosterNLPException("POS_french:" + e.getMessage());
        }
