 ...
 * @author 尚宏
 */
public class POS_english implements PosterNLPSegImpl {

    private static String models_path = "model/";
    private static String model_english = "english-caseless-left3words-distsim.tagger";
    private static MaxentTagger tagger = new MaxentTagger(models_path + model_english);
    ...
    public String[] getStringToken(String str) throws PosterNLPException {
        try {
            ...
            throw new PosterNLPException("POS_english:" + e.getMessage());
        }
    }
