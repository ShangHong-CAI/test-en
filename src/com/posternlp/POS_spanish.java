 ...
 * @author 尚宏
 */
public class POS_spanish implements PosterNLPSegImpl {

    private static String models_path = "model/";
    private static String model_spanish = "spanish-distsim.tagger";
    ...
    public String[] getStringToken(String str) throws PosterNLPException {
        try {
            ...
            throw new PosterNLPException("POS_spanish:" + e.getMessage());
        }
    }
